...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bob Brow", "bob@hotmail", new DateTime(1987, 06, 25), 2500.00, d1);
            Seller s2 = new Seller(2, "Ana", "Ana@hotmail", new DateTime(1989, 05, 12), 2300.00, d3);
            Seller s3 = new Seller(3, "Luca", "luca@hotmail", new DateTime(1984, 9, 29), 4000.00, d2);
            Seller s4 = new Seller(4, "Lis", "Lis@hotmail", new DateTime(1990, 02, 15), 3000.00, d4);
            Seller s5 = new Seller(5, "Tom", "Tom@hotmail", new DateTime(1990, 07, 15), 3000.00, d1);
            Seller s6 = new Seller(6, "Lis", "Lis@hotmail", new DateTime(1990, 08, 3), 3500.00, d2);
